//Lisbeth Lazala
//Solution with pthread libraries
...
void * smoker_tobacco(void * arg){
    ...
    while(counter<3){
        ...
        agent_job = 1;
        puts("Tobacco Smoker: now making a cigarette...");
        pthread_mutex_unlock(&smoker);

        puts("Tobacco Smoker: Now smoking...");
    }
    counter++;
    return 0;
}
...
void * smoker_paper(void * arg){
    ...
    while(counter<3){
        ...
        smoker_paper_job = 0;
        agent_job = 1;
        puts("Paper Smoker: now making a cigarette...");
        pthread_mutex_unlock(&smoker);

        puts("Paper Smoker: Now smoking...");
    }
    counter++;
    return 0;
}
...
void * smoker_match(void * arg){
    ...
    while(counter<3){
        ...
        smoker_match_job = 0;
        agent_job = 1;
        puts("Match Smoker: now making a cigarette...");
        pthread_mutex_unlock(&smoker);

        puts("Match Smoker: now smoking...");
    }
    counter++;
    return 0;
}
